...
public class Tree {
    ...
    private Node receiveHeir(Node node) {
        MyExamples.Program19.Node parentNode = node;
        MyExamples.Program19.Node heirNode = node;
        MyExamples.Program19.Node currentNode = node.getRightChild(); // Переход к правому потомку
